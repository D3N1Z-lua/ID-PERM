...
exports.DenizUniqueID:GetUIDfromID()   -- Get uid from player id

exports.DenizUniqueID:GetIDfromUID()   -- Get id from player uid
...
TriggerEvent('es:addGroupCommand', 'setjob', 'moderator', function(source, args, user)
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		local xPlayer = ESX.GetPlayerFromId(exports.DenizUniqueID:GetIDfromUID(tonumber(args[1])))
...
local targetPlayer = exports.DenizUniqueID:GetIDfromUID(tonumber(args[k]))